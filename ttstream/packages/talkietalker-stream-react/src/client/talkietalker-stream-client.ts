...
export type TalkieTalkerStreamClientOptions = {
  publishKey?: string
  tokenPath?: string
  initialToken?: string
  initialWsUrl?: string
...
export class TalkieTalkerStreamClient {
  ...
  private static instance: TalkieTalkerStreamClient | null = null
  ...
  static create(options?: TalkieTalkerStreamClientOptions): TalkieTalkerStreamClient {
    if (!options || Object.keys(options).length === 0) {
      if (!TalkieTalkerStreamClient.instance) {
        TalkieTalkerStreamClient.instance = new TalkieTalkerStreamClient()
      }
      return TalkieTalkerStreamClient.instance
    }
    return new TalkieTalkerStreamClient(options)
  }
