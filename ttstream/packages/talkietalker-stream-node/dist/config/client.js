import { ENV_NAMES, isPublishableKey, isSecretKey, resolveBaseUrl, } from './endpoints.js';
...
export function resolveClientConfig(overrides = {}) {
    ...
    if (!secretKey) {
        throw new Error(`Missing secretKey. Pass secretKey or set ${ENV_NAMES.secretKey}.`);
    }
