...
export class RateLimitError extends TalkieTalkerStreamError {
  ...
  constructor(opts: TalkieTalkerStreamErrorOptions & { retryAfter?: number }) {
    super(opts)
...
export function parseError(status: number, body: unknown, headerRequestId?: string): TalkieTalkerStreamError {
