...
import type { Participant } from "../client/streamflow-client.js"
import { useStreamFlowClient } from "../components/streamflow.js"
...
export type StreamFlowRoomFeatures = {
  chat?: boolean
  screenShare?: boolean
  waitingRoom?: boolean
}

export type StreamFlowRoomProps = {
  roomId: string
...
export function StreamFlowRoom({
  roomId,
  participant,
  hostUserId,
  theme = "dark",
