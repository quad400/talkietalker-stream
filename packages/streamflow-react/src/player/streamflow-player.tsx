...
import { getStreamFlowConfig, setStreamFlowConfig, themeToCssVars } from "../core/config.js"
...
export type StreamFlowPlayerProps = {
  streamId: string
  token?: string
  wsUrl?: string
  theme?: "dark" | "light"
...
export function StreamFlowPlayer({
  streamId,
  token,
  wsUrl,
  theme = "dark",
